...
// Just copy Turbine Rotor :)
public class TileEntityChemicalReactorRotor extends TileEntityInternalMultiblock implements Clearable {
    ...
    public TileEntityChemicalReactorRotor(BlockPos pos, BlockState state) {
        super(ExtraBlock.CHEMICAL_REACTOR_ROTOR, pos, state);
    }
    ...
    public void updateRotors() {
        ...
        TileEntityChemicalReactorRotor rotor = getRotor(getBlockPos().below());
        if (rotor == null) {
    ...
    private void scanRotors(int index) {
        ...
        TileEntityChemicalReactorRotor rotor = getRotor(getBlockPos().above());
        if (rotor != null) {
    ...
    public boolean addBlade(boolean checkBelow) {
        if (checkBelow) {
            ...
            TileEntityChemicalReactorRotor previous = getRotor(getBlockPos().below());
        ...
        TileEntityChemicalReactorRotor next = getRotor(getBlockPos().above());
    ...
    @Nullable
    private TileEntityChemicalReactorRotor getRotor(BlockPos pos) {
        return WorldUtils.getTileEntity(TileEntityChemicalReactorRotor.class, getLevel(), pos);
    }
